...
void Preferences::Read()
{
    ...
    OrthographicFlag = settings.value("OrthographicFlag", true).toBool();
    ...
    OpenGLMultisample = settings.value("OpenGLMultisample", 8).toInt();
    ...
    DefaultCameraFrontClip = settings.value("DefaultCameraFrontClip", 0).toDouble();
    DefaultCameraBackClip = settings.value("DefaultCameraBackClip", 0).toDouble();
...
void Preferences::Write()
{
    ...
    settings.setValue("OrthographicFlag", OrthographicFlag);
    ...
    settings.setValue("OpenGLMultisample", OpenGLMultisample);
    ...
    settings.setValue("DefaultCameraFrontClip", DefaultCameraFrontClip);
    settings.setValue("DefaultCameraBackClip", DefaultCameraBackClip);
