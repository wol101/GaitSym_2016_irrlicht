    ...
    m_ui(new Ui::DialogOutputSelect)
{
    ...
    Simulation *simulation = mainWindow->GetSimulation();
    ...
    if (bodyList->size() > 0)
    {
        ...
        m_columns++;
        QObject::connect(listWidgetBody, SIGNAL(customContextMenuRequested(QPoint)), this, SLOT(menuRequestBody(QPoint)));
    }
    ...
    if (jointList->size() > 0)
    {
        ...
        gridLayout->addWidget(label, 0, m_columns);
        m_columns++;
        QObject::connect(listWidgetJoint, SIGNAL(customContextMenuRequested(QPoint)), this, SLOT(menuRequestJoint(QPoint)));
    }
    ...
    if (geomList->size() > 0)
    {
        ...
        gridLayout->addWidget(label, 0, m_columns);
        m_columns++;
        QObject::connect(listWidgetGeom, SIGNAL(customContextMenuRequested(QPoint)), this, SLOT(menuRequestGeom(QPoint)));
    }
    ...
    if (muscleList->size() > 0)
    {
        ...
        gridLayout->addWidget(label, 0, m_columns);
        m_columns++;
        QObject::connect(listWidgetMuscle, SIGNAL(customContextMenuRequested(QPoint)), this, SLOT(menuRequestMuscle(QPoint)));
    }
    ...
    if (driverList->size() > 0)
    {
        ...
        gridLayout->addWidget(label, 0, m_columns);
        m_columns++;
        QObject::connect(listWidgetDriver, SIGNAL(customContextMenuRequested(QPoint)), this, SLOT(menuRequestDriver(QPoint)));
    }
    ...
    if (dataTargetList->size() > 0)
    {
        ...
        gridLayout->addWidget(label, 0, m_columns);
        m_columns++;
        QObject::connect(listWidgetDataTarget, SIGNAL(customContextMenuRequested(QPoint)), this, SLOT(menuRequestDataTarget(QPoint)));
    }
    ...
    if (warehouseList->size() > 0)
    {
        ...
        for (warehouseIterator = warehouseList->begin(); warehouseIterator != warehouseList->end(); warehouseIterator++)
        {
        ...
        gridLayout->addWidget(label, 0, m_columns);
        m_columns++;
        QObject::connect(listWidgetWarehouse, SIGNAL(customContextMenuRequested(QPoint)), this, SLOT(menuRequestWarehouse(QPoint)));
    }
